...
{
	ShowMessage("Додаток розроблено RenRin.\nТехнічна підтримка: LerellaSS@gmail.com");
}
//---------------------------------------------------------------------------

void __fastcall TForm2::N6Click(TObject *Sender)
{
	ShowMessage("Класичний сонет: 4+4+3+3 абаб абаб вгв гдд\nСонет з кодою: 4+4+3+3+1 абаб абаб вгв гдд е\nСуцільний сонет: 4+4+3+3 абаб абаб вгв вгв\nБезголовийсонет: 4+3+3 абаб вгв гдд\nПеревернутий сонет: 3+3+4+4 вгв гдд абаб абаб");
}
//---------------------------------------------------------------------------
